...
" editor
call s:h("Normal",        { "fg": s:green,      "bg": s:black })
...
call s:h("javaScriptBrowserObjects", { "fg": s:green })
call s:h("javaScriptFunKeyword", { "fg": s:aqua })
call s:h("javaScriptDeprecated", { "fg": s:green })
call s:h("javaScriptBraces",    { "fg": s:white, "format": "bold" })
call s:h("javaScriptParens",    { "fg": s:white, "format": "bold" })
call s:h("javaScriptWebAPI",     { "fg": s:white, "format": "bold" })
call s:h("jsArrowFunction",     { "fg": s:pink })
call s:h("javaScriptIdentifier",{ "fg": s:aqua })
call s:h("jsVariableDef",       { "fg": s:green })
